...
class ChatCubit extends Cubit<ChatState> {
  ...
  final String apiKey = 'AIzaSyDRLRbqMVfDKqN0kTa4lKWECc4ikq9rTyk';
  final String geminiUrl =
      'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyDRLRbqMVfDKqN0kTa4lKWECc4ikq9rTyk';
